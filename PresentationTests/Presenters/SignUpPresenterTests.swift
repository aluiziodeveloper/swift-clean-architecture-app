...
extension SignUpPresenterTests {
    ...
    func makeSignUpViewModel(name: String? = "any_name", email: String? = "a@a.com", password: String? = "any_password", passwordConfirmation: String? = "any_password") -> SignUpViewModel {
