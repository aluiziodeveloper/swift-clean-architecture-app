...
extension RemoteAddAccountTests {
    func makeSut(url: URL = URL(string: "http://localhost.com")!, file: StaticString = #file, line: UInt = #line) -> (sut: RemoteAddAccount, httpClientSpy: HttpClientSpy) {
        let httpClientSpy = HttpClientSpy()
    ...
    func makeAddAccountModel() -> AddAccountModel {
        return AddAccountModel(name: "any_name", email: "a@a.com", password: "any_password", passwordConfirmation: "any_password")
    }
